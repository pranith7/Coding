...
int maxProfit(vector<int>& prices, int n) //REcursion + Memorisation
{
...
int maxProfit(vector<int>& Arr, int n) //Tabulation
{
...
int maxProfit(vector<int>& Arr, int n) //space optimisation
{
