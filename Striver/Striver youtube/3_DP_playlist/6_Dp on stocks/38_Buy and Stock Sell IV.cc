...
int maximumProfit(vector<int>& prices, int n, int k) //Recursion + Memorisation
{
...
int maximumProfit(vector<int>& Arr, int n, int k) //Tabulation
{
...
int maxProfit(vector<int>& Arr, int n, int k) //space optimisation
{
