...
int maximumProfit(int n, int fee, vector<int>& Arr) //Recursion + Memorisation
{
...
int maximumProfit(int n, int fee, vector<int>& Arr) //tabulation
{
    //Write your code here
    if(n==0) return 0;
...
int maximumProfit(int n, int fee, vector<int>& Arr) //space optimisation
{
    if(n==0) return 0;
