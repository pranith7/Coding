...
/*
    ...
    and to the left if the characters are equal, or to 0 plus the maximum value of the cells directly 
    above or to the left of it if the characters are not equal.
